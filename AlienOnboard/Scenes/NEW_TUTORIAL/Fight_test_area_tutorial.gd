...
@onready var fade_animation_player = $FadeToBlackAnimation/AnimationPlayer
@onready var fade_rect = $FadeToBlackAnimation/CanvasLayer/FadeRect
...
func _ready():
	...
	fade_rect.hide()  # Ensure the fade_rect is hidden initially
...
func fade_to_black() -> void:
	fade_rect.show()
	fade_animation_player.play("FadeToBlack")
